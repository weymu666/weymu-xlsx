...
import com.weymu.xlsx.common.ResponseDTO;
import com.weymu.xlsx.service.MessageProcess;
import com.weymu.xlsx.utils.PakoGzipUtils;
...
public class WebSocketServer {
     ...
     */
    public static ConcurrentHashMap<String, Map<String, WebSocketServer>> webSocketMap = new ConcurrentHashMap<>();
    /**
        ...
        if (StrUtil.isNotBlank(message)) {
            try {
                ...
                if (!"mv".equals(jsonObject.getStr("t"))) {
                    webSocketServer.messageProcess.process(gridKey, jsonObject);
                }
                Map<String, WebSocketServer> sessionMap = webSocketMap.get(gridKey);
